...
layui.config({
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							...
							'<div class="admin-header-lock-name" id="lockUserName">ChengQ</div>'+
							'<div class="input_btn">'+
	...
	$("body").on("click","#unlock",function(){
		if($(this).siblings(".admin-header-lock-input").val() == ''){
			...
			if($(this).siblings(".admin-header-lock-input").val() == "chengqing"){
	...
	function showNotice(){
		layer.open({
	        ...
	        btn: ['火速围观'],
	        moveType: 1,
	        content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>大家好这里是ChengQ博客的管理后台哟。</p><p>如果我是DJ,你会爱我么？</p></div>',
